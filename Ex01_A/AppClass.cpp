...
#pragma region YOUR CODE GOES HERE
	...
	if (fTimer < 2)
	{
		modelMatrix *= glm::translate(0.0f, 1.5f * fTimer, 0.0f);
	}
	else
	{
		modelMatrix *= glm::translate(0.0f, (4 - fTimer) * 1.5f, 0.0f);
	}
	quaternion quat2 = glm::angleAxis(180.0f * fTimer, vector3(0.0f, 0.0f, 1.0f));
